    ...
    schemas: {
      ...
      User: {
        ...
        properties: {
          ...
          email: { type: 'string', format: 'email', example: 'sarah.jenkins@acmecorp.com' },
          role: {
            type: 'string',
            enum: ['SUPER_ADMIN', 'COMPANY_ADMIN', 'COMPLIANCE_OFFICER', 'DEPARTMENT_MANAGER', 'AUDITOR', 'STAFF'],
          ...
          phoneNumber: { type: 'string', example: '+1-555-0192' },
      ...
      Company: {
        ...
        properties: {
          ...
          name: { type: 'string', example: 'Acme Global Industries' },
          code: { type: 'string', example: 'ACME' },
          registrationNumber: { type: 'string', example: 'REG-2024-99812' },
          taxId: { type: 'string', example: 'TAX-8829103' },
          contactEmail: { type: 'string', example: 'contact@acmeglobal.com' },
          industry: { type: 'string', example: 'Manufacturing & Chemical Logistics' },
          status: { type: 'string', enum: ['ACTIVE', 'INACTIVE', 'SUSPENDED'], example: 'ACTIVE' },
      ...
      RenewalRecord: {
        ...
        properties: {
          ...
          renewalCost: { type: 'number', example: 4500.0 },
      ...
      Notification: {
        ...
        properties: {
          ...
          message: { type: 'string', example: 'EPA Permit EPA-HAZ-2026-9081 will expire in 30 days.' },
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  role: { type: 'string', enum: ['SUPER_ADMIN', 'COMPANY_ADMIN', 'COMPLIANCE_OFFICER', 'DEPARTMENT_MANAGER', 'AUDITOR', 'STAFF'], example: 'COMPLIANCE_OFFICER' },
                  companyId: { type: 'string', example: '66a5e1234567890abcdef100' },
                  departmentId: { type: 'string', example: '66a5e1234567890abcdef200' },
                },
              },
          ...
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  email: { type: 'string', example: 'sarah.jenkins@acmecorp.com' },
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  name: { type: 'string', example: 'Sarah Jenkins-Smith' },
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['email'],
                properties: { email: { type: 'string', example: 'sarah.jenkins@acmecorp.com' } },
              },
            },
          },
        },
          ...
          content: {
            'application/json': {
              schema: {
                ...
                required: ['name', 'code'],
                properties: {
                  name: { type: 'string', example: 'Acme Global Logistics' },
                  code: { type: 'string', example: 'ACME' },
                  registrationNumber: { type: 'string', example: 'REG-2024-991' },
                  taxId: { type: 'string', example: 'TAX-12345' },
                  contactEmail: { type: 'string', example: 'info@acmeglobal.com' },
                  industry: { type: 'string', example: 'Logistics & Supply Chain' },
                },
              },
            },
          },
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  name: { type: 'string', example: 'Acme International Enterprises' },
                  contactEmail: { type: 'string', example: 'support@acmeglobal.com' },
                },
              },
            },
          },
                ...
                example: {
                  ...
                  data: {
                    ...
                    company: {
                      ...
                      industry: 'Manufacturing & Chemical Logistics',
                      status: 'ACTIVE',
                    },
                    document: {
            ...
            'multipart/form-data': {
              schema: {
                ...
                properties: {
                  ...
                  notes: { type: 'string', example: 'Permit extension request submitted with state fee payment.' },
